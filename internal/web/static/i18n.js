...
const ICONS = {
  ...
  branch: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><circle cx="7" cy="5" r="2.2"></circle><circle cx="7" cy="19" r="2.2"></circle><circle cx="17" cy="12" r="2.2"></circle><path d="M7 7.2v9.6"></path><path d="M7 12h7.8"></path></svg>',
